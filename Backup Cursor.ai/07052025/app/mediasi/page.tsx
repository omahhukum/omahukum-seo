          ...
          <div className="prose prose-lg mx-auto">
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>Proses cepat dan biaya lebih terjangkau</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✅</span>
                  <span>Bersifat rahasia dan menjaga hubungan baik</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✅</span>
                  <span>Tidak ada keputusan sepihak – hasil ditentukan oleh kesepakatan bersama</span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-600 mr-2">✅</span>
                  <span>Dapat dilaksanakan sebelum atau selama proses hukum di pengadilan</span>
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>Mediasi sengketa keluarga (perceraian, warisan, hak asuh anak)</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Sengketa bisnis dan perjanjian kerja sama</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Konflik ketenagakerjaan</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">•</span>
                  <span>Masalah perdata lainnya</span>
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <ol className="space-y-3 text-gray-700 list-decimal list-inside">
                <li>Konsultasi awal & identifikasi sengketa</li>
                <li>Penunjukan mediator dari tim hukum</li>
                <li>Sesi mediasi (tatap muka atau daring)</li>
                <li>Kesepakatan tertulis (jika berhasil)</li>
              </ol>
            </section>
            ...
            <div className="bg-blue-50 rounded-xl p-8 text-center border border-blue-100">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link 
                  href="https://api.whatsapp.com/send/?phone=6281225425169&text=Saya+%5BNama%5D+ingin+konsultasi+mediasi+dengan+Omah+Hukum+terkait+%5BPermasalahan+Anda%5D.+Saya+mengetahui+informasi+ini+melalui+website+resmi+Omah+Hukum.&type=phone_number&app_absent=0"
                  target="_blank"
