...
export default function ArticleJsonLd({ article }: ArticleJsonLdProps) {
  const articleSchema = {
    ...
    image: article.gambar || 'https://omahhukum-jatim.vercel.app/logo_omah_hukum.png',
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://omahhukum-jatim.vercel.app/logo_omah_hukum.png'
      }
    },
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://omahhukum-jatim.vercel.app/artikel/${article.id}`
    }
  }
